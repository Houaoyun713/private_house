<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="支持方式" prop="mode">
        <el-input
    ...
    <el-table v-loading="loading" :data="modeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="支持方式" align="center" prop="mode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="支持方式" prop="mode">
          <el-input v-model="form.mode" placeholder="请输入支持方式" />
        </el-form-item>
        <el-form-item label="备注" prop="remarks">
...
<script>
import { listMode, getMode, delMode, addMode, updateMode } from "@/api/mode/mode";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除支持方式的数据项？').then(function() {
        return delMode(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('mode/mode/export', {
        ...this.queryParams
      }, `支持方式.xlsx`)
    }
  }
