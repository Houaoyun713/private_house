...
<script>
import { listMain, getMain, delMain, addMain, updateMain } from "@/api/main/main";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除课题维护编号为"' + ids + '"的数据项？').then(function() {
        return delMain(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('main/main/export', {
        ...this.queryParams
